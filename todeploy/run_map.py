...
def run_script_on_remote(host, user, index):
    ...
    command = f"python3 /cal/exterieurs/rnaji-24/MapReducePython/todeploy/map_local.py {index} {N}"
...
# On pourrait créer un fichier run_parallel.py ou l'on ajoute le chemin de script du script à faire tourner en parallèle 